...
class GPUTPCNNClusterizerHost
{
 public:
  ...
  void initClusterizer(const GPUSettingsProcessingNNclusterizer&, GPUTPCNNClusterizer&, int32_t = -1, int32_t = -1, int32_t = 1);
  ...
  void digitWriter(GPUTPCClusterFinder&, std::string);
