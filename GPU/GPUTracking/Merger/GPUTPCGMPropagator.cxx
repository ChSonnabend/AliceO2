...
GPUd() int32_t GPUTPCGMPropagator::Update(float posY, float posZ, int32_t iRow, const GPUParam& GPUrestrict() param, int16_t clusterState, int8_t rejectChi2, bool refit, int8_t sector, float time, float avgInvCharge, float invCharge)
{
  ...
  return Update(posY, posZ, iRow, param, clusterState, rejectChi2, refit, sector, time, err2Y, err2Z, avgInvCharge, invCharge);
}

GPUd() int32_t GPUTPCGMPropagator::Update(float posY, float posZ, int32_t iRow, const GPUParam& GPUrestrict() param, int16_t clusterState, int8_t rejectChi2, bool refit, int8_t sector, float time, float err2Y, float err2Z, float avgInvCharge, float invCharge)
{
