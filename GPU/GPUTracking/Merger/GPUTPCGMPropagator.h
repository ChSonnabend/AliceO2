...
class GPUTPCGMPropagator
{
 public:
  ...
  GPUd() int32_t Update(float posY, float posZ, int32_t iRow, const GPUParam& param, int16_t clusterState, int8_t rejectChi2, bool refit, int8_t sector, float time, float err2Y, float err2Z, float avgInvCharge, float invCharge);
