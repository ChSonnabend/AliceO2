...
class GPUChain
{
 ...
 protected:
  ...
  inline void SetONNXGPUStream(Ort::SessionOptions& opt, int32_t stream, int32_t* deviceId, const std::string& inferenceDevice = {}) { mRec->SetONNXGPUStream(opt, stream, deviceId, inferenceDevice); }
