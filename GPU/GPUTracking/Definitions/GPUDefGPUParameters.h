...
#define GPUCA_LB_GPUTPCNNClusterizerKernels_removeAllSplitFlags GPUCA_LB_GPUTPCNNClusterizerKernels
#define GPUCA_LB_GPUTPCNNClusterizerKernels_setDeconvolutionFlags GPUCA_LB_GPUTPCNNClusterizerKernels
