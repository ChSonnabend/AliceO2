...
AddOption(nnClusterizerDumpTrainingData, int, 0, "", 0, "(int, default =0) If >0, input data of the neural network will be dumped in GPUChainTrackingClusterizer as per-file data")
