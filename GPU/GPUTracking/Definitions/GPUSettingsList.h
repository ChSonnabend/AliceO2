...
AddOption(setDeconvolutionFlags, int, 1, "", 0, "Set the flags of the charge map identical to the deconvolution kernel flags")
...
AddOption(nnClusterizerForceGpuInputFill, int, 0, "", 0, "Forces to use the fillInputNNGPU function. Mainly used for testing if the function works properly.")
// CCDB
