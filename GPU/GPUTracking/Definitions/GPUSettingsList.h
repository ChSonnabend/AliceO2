...
AddOption(nnUseClusterErrorNetwork, int, 0, "", 0, "If 1, the cluster error network is used to parametrize the cluster errors, else a fixed parametrization is used")
...
AddOption(nnClusterErrorNetworkVersion, int, 1, "", 0, "Cluster error network version")
AddOption(nnScaleClusterErrorY, float, 1.0, "", 0, "Scale factor (y) for the cluster errors predicted by the network, can be used to effectively increase or decrease the cluster errors without retraining the network")
AddOption(nnScaleClusterErrorZ, float, 1.0, "", 0, "Scale factor (z) for the cluster errors predicted by the network, can be used to effectively increase or decrease the cluster errors without retraining the network")
AddOption(scaleChiY1, float, 1.0, "", 0, "Scale factor")
AddOption(scaleChiY2, float, 1.0, "", 0, "Scale factor")
AddOption(scaleChiY3, float, 1.0, "", 0, "Scale factor")
AddOption(scaleChiZ1, float, 1.0, "", 0, "Scale factor")
AddOption(scaleChiZ2, float, 1.0, "", 0, "Scale factor")
AddOption(scaleChiZ3, float, 1.0, "", 0, "Scale factor")
// CCDB
