...
AddOption(nnInferenceVerbosity, int, 3, "", 0, "Same scaling as info-logger")
...
AddOption(nnBoundaryFillValue, float, -1.f, "", 0, "The value with which the charge array input to the network is filled at the boundaries.")
AddHelp("help", 'h')
EndConfig()
#endif // __OPENCL__
